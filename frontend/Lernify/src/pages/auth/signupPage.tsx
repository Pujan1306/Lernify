  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background font-sans">
      <div className="w-full max-w-[440px] bg-card rounded-4xl shadow-xl p-6 sm:p-8 flex flex-col items-center relative transition-all duration-300">
        ...
        <p className="text-muted-foreground text-sm mb-5">Join us to start your journey</p>

        {/* Form */}
        <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-3.5">
          {/* Name Field */}
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-foreground uppercase tracking-wider" htmlFor="register-name">
              Full Name
            </label>
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-11 pr-4 py-2.5 bg-background border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors ${errors.name ? 'border-destructive focus:ring-destructive/20 focus:border-destructive' : 'border-border'
                  }`}
                {...register('name')}
              />
            </div>
          ...
          {/* Email Field */}
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-foreground uppercase tracking-wider" htmlFor="register-email">
              Email
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          {/* Password Field */}
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-foreground uppercase tracking-wider" htmlFor="register-password">
              Password
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
